...
g = DynamicGraphs("L2: Аппроксимация функции", figsize=(10, 6))
...
g.drow_graph(x, y, color='blue', base_setting=False, linewidth=3, label=func_str)

model_str = r"$a(x) = w_0 + w_1x + w_2x^2 + w_3x^3 + ... + w_{21}x^{21}$"
g.drow_graph(x, model_res, base_setting=False, color='red', linewidth=3, label=model_str)
